...
# %%
    ...
    ##new congater class
congmodel = AdapterModel(custom_encoder=query_encoder,
                              d_model=args.d_model,
                              num_heads=args.num_heads,
                              num_decoder_layers=args.num_layers,
                              dim_feedforward=args.dim_feedforward,
...
# output = congmodel(**model_inp, w = {"gender": 0}, bias_regul_coeff = 0)
# output
...
train(args, congmodel, eval_dataloader, tokenizer, fairrmetric)
